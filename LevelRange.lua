...
-- Level Ranges
LEVELRANGE_RANGES = {
    [LEVELRANGE_ELWYNN]                 = { 1, 10, LEVELRANGE_ALLIANCE},
    [LEVELRANGE_DUNMOROGH]              = { 1, 10, LEVELRANGE_ALLIANCE},
    [LEVELRANGE_TIRISFAL]               = { 1, 10, LEVELRANGE_HORDE},
    [LEVELRANGE_LOCHMODAN]              = {10, 20, LEVELRANGE_ALLIANCE},
    [LEVELRANGE_SILVERPINE]             = {10, 20, LEVELRANGE_HORDE},
    [LEVELRANGE_WESTFALL]               = {10, 20, LEVELRANGE_ALLIANCE},
    [LEVELRANGE_REDRIDGE]               = {15, 25, LEVELRANGE_CONTESTED},
    [LEVELRANGE_DUSKWOOD]               = {18, 30, LEVELRANGE_CONTESTED},
    [LEVELRANGE_HILLSBRAD]              = {20, 30, LEVELRANGE_CONTESTED},
    [LEVELRANGE_WETLANDS]               = {20, 30, LEVELRANGE_CONTESTED},
    [LEVELRANGE_ALTERAC]                = {30, 40, LEVELRANGE_CONTESTED},
    [LEVELRANGE_ARATHI]                 = {30, 40, LEVELRANGE_CONTESTED},
    [LEVELRANGE_STRANGLETHORN]          = {30, 45, LEVELRANGE_CONTESTED},
    [LEVELRANGE_BADLANDS]               = {35, 45, LEVELRANGE_CONTESTED},
    [LEVELRANGE_SORROWS]                = {35, 45, LEVELRANGE_CONTESTED},
    [LEVELRANGE_HINTERLANDS]            = {40, 50, LEVELRANGE_CONTESTED},
    [LEVELRANGE_SEARINGGORGE]           = {43, 50, LEVELRANGE_CONTESTED},
    [LEVELRANGE_BLASTEDLANDS]           = {45, 55, LEVELRANGE_CONTESTED},
    [LEVELRANGE_BURNINGSTEPPE]          = {50, 58, LEVELRANGE_CONTESTED},
    [LEVELRANGE_WESTERNPLAGUE]          = {51, 58, LEVELRANGE_CONTESTED},
    [LEVELRANGE_EASTERNPLAGUE]          = {53, 60, LEVELRANGE_CONTESTED},
    [LEVELRANGE_DEADWINDPASS]           = {55, 60, LEVELRANGE_CONTESTED},

    [LEVELRANGE_DUROTAR]                = { 1, 10, LEVELRANGE_HORDE},
    [LEVELRANGE_MULGORE]                = { 1, 10, LEVELRANGE_HORDE},
    [LEVELRANGE_DARKSHORE]              = {10, 20, LEVELRANGE_ALLIANCE},
    [LEVELRANGE_BARRENS]                = {10, 25, LEVELRANGE_HORDE},
    [LEVELRANGE_STONETALON]             = {15, 27, LEVELRANGE_CONTESTED},
    [LEVELRANGE_ASHENVALE]              = {18, 30, LEVELRANGE_CONTESTED},
    [LEVELRANGE_1KNEEDLES]              = {25, 35, LEVELRANGE_CONTESTED},
    [LEVELRANGE_DESOLACE]               = {30, 40, LEVELRANGE_CONTESTED},
    [LEVELRANGE_DUSTWALLOW]             = {35, 45, LEVELRANGE_CONTESTED},
    [LEVELRANGE_FERALAS]                = {40, 50, LEVELRANGE_CONTESTED},
    [LEVELRANGE_TANARIS]                = {40, 50, LEVELRANGE_CONTESTED},
    [LEVELRANGE_AZSHARA]                = {45, 55, LEVELRANGE_CONTESTED},
    [LEVELRANGE_FELWOOD]                = {48, 55, LEVELRANGE_CONTESTED},
    [LEVELRANGE_UNGOROCRATER]           = {48, 55, LEVELRANGE_CONTESTED},
    [LEVELRANGE_SILITHUS]               = {55, 60, LEVELRANGE_CONTESTED},
    [LEVELRANGE_WINTERSPRING]           = {55, 60, LEVELRANGE_CONTESTED},

    [LEVELRANGE_MOONGLADE]              = { 1, 60, LEVELRANGE_CONTESTED},
    [LEVELRANGE_TELDRASSIL]             = { 1, 10, LEVELRANGE_ALLIANCE},

    -- Turtle WoW Zones
    [LEVELRANGE_THALASSIANHIGHLANDS]    = { 1, 10, LEVELRANGE_ALLIANCE},
    [LEVELRANGE_BLACKSTONEISLAND]       = { 1, 10, LEVELRANGE_HORDE},
    [LEVELRANGE_GILNEAS]                = {39, 46, LEVELRANGE_CONTESTED},
    [LEVELRANGE_GILLIJIM]               = {48, 53, LEVELRANGE_CONTESTED},
    [LEVELRANGE_LAPIDIS]                = {48, 53, LEVELRANGE_CONTESTED},
    [LEVELRANGE_TELABIM]                = {54, 60, LEVELRANGE_CONTESTED},
    [LEVELRANGE_SCARLETENCLAVE]         = {55, 60, LEVELRANGE_CONTESTED},
    [LEVELRANGE_HYJAL]                  = {58, 60, LEVELRANGE_CONTESTED},
    -- added in patch 1.18
    [LEVELRANGE_GRIMREACHES]            = {33, 38, LEVELRANGE_CONTESTED},
    [LEVELRANGE_NORTHWIND]              = {28, 34, LEVELRANGE_CONTESTED},
    [LEVELRANGE_BALOR]                  = {29, 34, LEVELRANGE_CONTESTED},
};
...
local function lUpdateTooltip(zoneName)
    ...
    if (LEVELRANGE_RANGES[zoneName]) then
        ...
        if (side == LEVELRANGE_CONTESTED) then
